...
#    include_per_arch = True
    ...
    def get_zbar_env(self, arch):
        ...
        build_env['LDFLAGS'] += " -lios -lpython3 -lzbar"
        return build_env
    ...
    def install(self):
        ...
        build_dir = join(self.get_build_dir(arch.arch),'src','zbarlight')
        dist_dir  = join(self.ctx.dist_dir,'root','python3','lib','python3.7','site-packages','zbarlight')
